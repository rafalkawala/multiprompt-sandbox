...
# You'll need to manually set these secrets:
# - multiprompt-db-password
# - multiprompt-secret-key
# - multiprompt-google-client-secret

echo ""
echo "Please create the following secrets in Secret Manager:"
echo "  gcloud secrets create multiprompt-db-password --data-file=-"
echo "  gcloud secrets create multiprompt-secret-key --data-file=-"
echo "  gcloud secrets create multiprompt-google-client-secret --data-file=-"
echo ""
